...
if __name__ == "__main__":
    ...
    # initialize proxy
    ##################
    p = idg.CPU.Optimized(nr_stations, nr_channels,
    ...
    # spheroidal
    spheroidal_subgrid = idg.utils.init_example_spheroidal_subgrid(subgrid_size)
    spheroidal_grid = idg.utils.init_example_spheroidal_grid(subgrid_size, grid_size)
