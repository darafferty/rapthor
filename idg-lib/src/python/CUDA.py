...
class Maxwell(Proxy):
    ...
    def get_job_size_gridder(self):
        return lib.CUDA_get_job_size_gridder(self.obj)

    def get_job_size_adder(self):
        return lib.CUDA_get_job_size_adder(self.obj)

    def get_job_size_splitter(self):
        return lib.CUDA_get_job_size_splitter(self.obj)

    def get_job_size_degridder(self):
        return lib.CUDA_get_job_size_degridder(self.obj)

    def set_job_size_gridder(self, n = 8192):
        lib.CUDA_set_job_size_gridder(self.obj, ctypes.c_int(n))

    def set_job_size_adder(self, n = 8192):
        lib.CUDA_set_job_size_adder(self.obj, ctypes.c_int(n))

    def set_job_size_splitter(self, n = 8192):
        lib.CUDA_set_job_size_splitter(self.obj, ctypes.c_int(n))

    def set_job_size_degridder(self, n = 8192):
        lib.CUDA_set_job_size_degridder(self.obj, ctypes.c_int(n))
