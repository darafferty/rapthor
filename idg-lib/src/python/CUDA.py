...
class Generic(CUDA):
    ...
    def __del__(self):
        """Destroy"""
        self.lib.CUDA_Generic_destroy(self.obj)
    ...
    def _cwrap_griddding(
        ...
        spheroidal_height,
        spheroidal_width):
        self.lib.CUDA_Generic_gridding(
            self.obj,
    ...
    def _cwrap_degridding(
        ...
        spheroidal_height,
        spheroidal_width):
        self.lib.CUDA_Generic_degridding(
            self.obj,
            ctypes.c_float(w_step),
            shift.ctypes.data_as(ctypes.c_void_p),
            ctypes.c_float(cell_size),
    ...
    def _cwrap_transform(
        ...
        height,
        width):
        self.lib.CUDA_Generic_transform(
            self.obj,
...
class Unified(CUDA):
    ...
    def _cwrap_griddding(
        ...
        spheroidal_height,
        spheroidal_width):
        self.lib.CUDA_Unified_gridding(
            self.obj,
            ctypes.c_float(w_step),
            shift.ctypes.data_as(ctypes.c_void_p),
            ctypes.c_float(cell_size),
    ...
    def _cwrap_degridding(
        ...
        spheroidal_height,
        spheroidal_width):
        self.lib.CUDA_Unified_degridding(
            self.obj,
            ctypes.c_float(w_step),
            shift.ctypes.data_as(ctypes.c_void_p),
            ctypes.c_float(cell_size),
    ...
    def _cwrap_transform(
        ...
        height,
        width):
        self.lib.CUDA_Unified_transform(
            self.obj,
            ctypes.c_int(direction),
            grid.ctypes.data_as(ctypes.c_void_p),
            ctypes.c_int(nr_correlations),
    ...
    def __del__(self):
        """Destroy"""
        self.lib.CUDA_Unified_destroy(self.obj)
