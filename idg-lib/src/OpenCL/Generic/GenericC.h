...
ProxyType* OpenCL_Generic_init(unsigned int nr_correlations,
...
void OpenCL_Generic_transform(ProxyType* p, int direction,
...
void OpenCL_Generic_destroy(ProxyType* p) { delete p; }
}  // end extern "C"
