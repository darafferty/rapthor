...
/* Index methods */
inline FUNCTION_ATTRIBUTES size_t index_grid(long grid_size, int w_layer,
                                             int pol, int y, int x) {
  // grid: [nr_w_layers][NR_CORRELATIONS][grid_size][grid_size]
  return static_cast<size_t>(w_layer) * NR_CORRELATIONS * grid_size *
             grid_size +
         static_cast<size_t>(pol) * grid_size * grid_size +
         static_cast<size_t>(y) * grid_size + static_cast<size_t>(x);
}

inline FUNCTION_ATTRIBUTES size_t index_grid_tiling(int tile_size,
...
inline FUNCTION_ATTRIBUTES size_t index_aterm(int subgrid_size, int nr_stations,
                                              int aterm_index, int station,
                                              int y, int x, int pol) {
...
inline FUNCTION_ATTRIBUTES size_t index_aterm_transposed(int subgrid_size,
                                                         int nr_stations,
                                                         int aterm_index,
                                                         int station, int y,
                                                         int x, int pol) {
