...
ProxyType* HybridCUDA_UnifiedOptimized_init() { return new ProxyType(); }
...
void HybridCUDA_UnifiedOptimized_transform(ProxyType* p, int direction,
...
void HybridCUDA_UnifiedOptimized_destroy(ProxyType* p) { delete p; }
}  // end extern "C"
