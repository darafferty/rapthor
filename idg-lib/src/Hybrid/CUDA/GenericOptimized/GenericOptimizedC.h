...
ProxyType* HybridCUDA_GenericOptimized_init() { return new ProxyType(); }
...
void HybridCUDA_GenericOptimized_transform(ProxyType* p, int direction,
...
void HybridCUDA_GenericOptimized_destroy(ProxyType* p) { delete p; }
}  // end extern "C"
