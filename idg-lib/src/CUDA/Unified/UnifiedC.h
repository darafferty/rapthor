...
ProxyType* CUDA_Unified_init() { return new ProxyType(); }

void CUDA_Unified_gridding(
...
void CUDA_Unified_transform(ProxyType* p, int direction,
...
void CUDA_Unified_destroy(ProxyType* p) { delete p; }
}  // end extern "C"
