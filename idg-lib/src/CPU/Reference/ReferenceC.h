...
ProxyType* CPU_Reference_init() { return new ProxyType(); }
...
void CPU_Reference_transform(ProxyType* p, int direction,
...
void CPU_Reference_destroy(ProxyType* p) { delete p; }
}  // end extern "C"
