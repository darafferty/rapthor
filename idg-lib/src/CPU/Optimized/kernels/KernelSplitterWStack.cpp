            ...
            for (int x = 0; x < subgrid_size; x++) {
                ...
                if (grid_x >= 1 && grid_x < grid_size-subgrid_size &&
                    ...
                    for (int pol = 0; pol < NR_POLARIZATIONS; pol++) {
                        ...
                        long src_idx = index_grid(NR_POLARIZATIONS, grid_size, w_layer, pol_idx, y_src, x_src);
                        long dst_idx = index_subgrid(NR_POLARIZATIONS, subgrid_size, s, pol_idx, y_dst, x_dst);
