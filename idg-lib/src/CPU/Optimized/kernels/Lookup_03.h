...
inline void compute_sincos_avx(unsigned* offset, const unsigned n,
...
inline void compute_sincos_altivec(unsigned* offset, const unsigned n,
                                   const float* __restrict__ x,
                                   float* __restrict__ sin,
                                   float* __restrict__ cos) {
#if defined(__PPC__)
...
inline void compute_sincos_scalar(unsigned* offset, const unsigned n,
                                  const float* __restrict__ x,
                                  float* __restrict__ sin,
                                  float* __restrict__ cos) {
...
inline void compute_sincos(const unsigned n, const float* __restrict__ x,
