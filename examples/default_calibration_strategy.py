...
for i in range(max_selfcal_loops):
    ...
    # Here we use the same solution intervals for every cycle. As an alternamtive, for
    # example, the intervals for the early cycles could be longer to compensate for the
    # generally lower signal-to-noise ratios of the solves
