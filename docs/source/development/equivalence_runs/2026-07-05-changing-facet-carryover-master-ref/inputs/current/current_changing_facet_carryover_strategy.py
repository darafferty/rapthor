"""Current-branch changing-facet DD phase-only carry-over scenario."""
...
CHANGING_FACET_PHASE_ONLY = {"dd": ["fast_phase", "medium_phase"], "di": []}


def _step(**overrides):
    step = {
        **COMMON_SETTINGS,
        "calibration_strategy": CHANGING_FACET_PHASE_ONLY,
    }
...
strategy_steps = [
    _step(),
    _step(do_image=False, max_directions=3),
]
