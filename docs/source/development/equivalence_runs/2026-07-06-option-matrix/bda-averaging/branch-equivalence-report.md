...
| --- | --- | ---: | --- | --- | --- | --- |
| base | `master` | 0 | `/app/docs/source/development/equivalence_runs/2026-07-06-option-matrix/inputs/base/bda_averaging.parset` | `/tmp/robb` | `/tmp/rob-bda/base/rapthor-command.log` | parset: `inputs/base/bda_averaging.parset`, strategy: `inputs/base/bda_averaging_strategy.py` |
| current | `current` | 0 | `/app/docs/source/development/equivalence_runs/2026-07-06-option-matrix/inputs/current/bda_averaging.parset` | `/tmp/robc` | `/tmp/rob-bda/current/rapthor-command.log` | parset: `inputs/current/bda_averaging.parset`, strategy: `inputs/current/bda_averaging_strategy.py` |
