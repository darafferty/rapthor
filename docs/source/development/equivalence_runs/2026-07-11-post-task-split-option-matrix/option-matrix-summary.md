...
Run root: `/app/runs/branch-option-matrix-20260711-post-task-split-rerun`
...
| `bda-averaging` | pass | 0 | 1 | 1 | 0 | 1 | `branch-equivalence-report.json` | DD fast+medium phase calibration with calibration BDA and imaging averaging/BDA enabled on the generated rich demo data. |
| `multi-sector-mosaic` | skipped | None | 0 | 0 | 0 | 0 |  | DD calibration, imaging, and mosaic assembly on a 2x2 sector grid using quadrant-balanced generated demo data. |
