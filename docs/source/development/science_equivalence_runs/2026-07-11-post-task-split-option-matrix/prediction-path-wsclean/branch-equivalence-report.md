...
| --- | --- | ---: | --- | --- | --- | --- |
| base | `master` | 0 | `/app/docs/source/development/science_equivalence_runs/2026-07-06-option-matrix/inputs/base/prediction_path_wsclean.parset` | `/tmp/ropwb` | `/app/runs/branch-option-matrix-20260711-post-task-split-rerun/prediction-path-wsclean/base/rapthor-command.log` | parset: `inputs/base/prediction_path_wsclean.parset`, strategy: `inputs/base/prediction_path_wsclean_strategy.py` |
| current | `current` | 0 | `/app/docs/source/development/science_equivalence_runs/2026-07-06-option-matrix/inputs/current/prediction_path_wsclean.parset` | `/tmp/ropwc` | `/app/runs/branch-option-matrix-20260711-post-task-split-rerun/prediction-path-wsclean/current/rapthor-command.log` | parset: `inputs/current/prediction_path_wsclean.parset`, strategy: `inputs/current/prediction_path_wsclean_strategy.py` |
