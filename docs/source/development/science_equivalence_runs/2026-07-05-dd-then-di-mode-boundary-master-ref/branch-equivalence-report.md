...
| --- | --- | ---: | --- | --- | --- | --- |
| base | `master` | 0 | `/app/docs/source/development/science_equivalence_runs/2026-07-05-dd-then-di-mode-boundary-master-ref/inputs/base/master_dd_then_di_mode_boundary.parset` | `/tmp/rbe-master-dd-then-di-mode-boundary-work` | `/app/runs/rbe-dd-then-di-mode-boundary-20260705/base/rapthor-command.log` | parset: `inputs/base/master_dd_then_di_mode_boundary.parset`, strategy: `inputs/base/master_dd_then_di_mode_boundary_strategy.py` |
| current | `current` | 0 | `/app/docs/source/development/science_equivalence_runs/2026-07-05-dd-then-di-mode-boundary-master-ref/inputs/current/current_dd_then_di_mode_boundary.parset` | `/tmp/rbe-current-dd-then-di-mode-boundary-work` | `/app/runs/rbe-dd-then-di-mode-boundary-20260705/current/rapthor-command.log` | parset: `inputs/current/current_dd_then_di_mode_boundary.parset`, strategy: `inputs/current/current_dd_then_di_mode_boundary_strategy.py` |
