"""Master-compatible DD-to-DI mode-boundary scenario.

The first selfcal cycle runs DD fast+medium phase-only calibration without DI
full-Jones. The second cycle adds DI full-Jones after the DD solve, matching
the only mixed-mode order that legacy master can express inside one cycle.
"""
