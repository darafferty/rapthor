...
| --- | --- | --- | --- |
| Saved-reference final gate | `docs/source/development/science_equivalence_runs/2026-07-06-saved-reference-final-gate/` | pass | Current Prefect/Dask path preserves the saved legacy product contract for all non-stale references. |
| Core DD phase plus DI full-Jones repeatability | `docs/source/development/science_equivalence_runs/2026-07-06-dd-phase-plus-di-fulljones-normalized-repeatability-master-ref/` | pass | All 15 base-base, current-current, and base-current pairs pass; cross-branch warnings are auxiliary output-record artifact names only. |
| Core DD phase plus DI full-Jones focused smoke | `docs/source/development/science_equivalence_runs/2026-07-06-dd-phase-plus-di-fulljones-normalized-master-ref/` | strict fail, classified | All h5parm products pass; remaining strict failures are repeatability-bounded small image residuals, PyBDSF diagnostic catalog columns, DS9 formatting, and legacy metadata shape. |
| Risk-based option matrix | `docs/source/development/science_equivalence_runs/2026-07-06-option-matrix/` | pass for active rows | Provided normalization sky models, DP3 image-based predict, WSClean predict, and BDA/averaging pass against `master`; screens are skipped until target tool support is available. |
...
```text
docs/source/development/science_equivalence_runs/2026-07-11-post-task-split-saved-reference/equivalence-report.json
docs/source/development/science_equivalence_runs/2026-07-11-post-task-split-saved-reference/equivalence-report.md
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-11-post-task-split-option-matrix/option-matrix-summary.json
docs/source/development/science_equivalence_runs/2026-07-11-post-task-split-option-matrix/option-matrix-summary.md
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-06-saved-reference-final-gate/equivalence-report.json
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-06-saved-reference-final-gate/equivalence-report.md
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-06-option-matrix/
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-05-phase-only-master-ref/
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-05-phase-only-initial-solutions-master-ref/
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-05-dd-phase-plus-di-fulljones-master-ref/
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-05-dd-phase-plus-di-fulljones-repeatability-master-ref/
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-05-fixed-facet-carryover-master-ref/
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-05-fixed-facet-repeatability-master-ref/
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-05-changing-facet-carryover-master-ref/
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-05-slow-gain-default-like-master-ref/
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-05-di-multicycle-carryover-master-ref/
```
...
```text
docs/source/development/science_equivalence_runs/2026-07-05-di-then-dd-mode-boundary-master-ref/
docs/source/development/science_equivalence_runs/2026-07-05-dd-then-di-mode-boundary-master-ref/
```
