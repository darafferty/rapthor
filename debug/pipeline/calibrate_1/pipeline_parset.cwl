...
steps:
  - id: make_sourcedb
    ...
    run: /project/rapthor/Software/rapthor.rap-423/lib/python3.6/site-packages/rapthor/pipeline/steps/make_sourcedb.cwl
    in:
      - id: in
  ...
  - id: solve_fast_phases
    ...
    run: /project/rapthor/Software/rapthor.rap-423/lib/python3.6/site-packages/rapthor/pipeline/steps/ddecal_solve_scalarphase.cwl
  ...
  - id: combine_fast_phases
    ...
    run: /project/rapthor/Software/rapthor.rap-423/lib/python3.6/site-packages/rapthor/pipeline/steps/collect_h5parms.cwl
    in:
      - id: inh5parms
...
# Solve for slow gains
  ...
  - id: solve_slow_gains1
    ...
    run: /project/rapthor/Software/rapthor.rap-423/lib/python3.6/site-packages/rapthor/pipeline/steps/ddecal_solve_complexgain1.cwl
  ...
  - id: process_slow_gains1
    ...
    run: /project/rapthor/Software/rapthor.rap-423/lib/python3.6/site-packages/rapthor/pipeline/steps/process_slow_gains.cwl
    in:
      - id: slowh5parm
  ...
  - id: combine_fast_and_slow_h5parms1
    ...
    doc: |
      ...
      table (h5parm file).
    run: /project/rapthor/Software/rapthor.rap-423/lib/python3.6/site-packages/rapthor/pipeline/steps/combine_h5parms.cwl
    in:
      - id: inh5parm1
        source: combine_fast_phases/outh5parm
      - id: inh5parm2
  ...
  - id: solve_slow_gains2
    ...
    doc: |
      ...
      solutions).
    run: /project/rapthor/Software/rapthor.rap-423/lib/python3.6/site-packages/rapthor/pipeline/steps/ddecal_solve_complexgain2.cwl
  ...
  - id: split_h5parms
    ...
    run: /project/rapthor/Software/rapthor.rap-423/lib/python3.6/site-packages/rapthor/pipeline/steps/split_h5parms.cwl
    in:
      - id: inh5parm
  ...
  - id: make_aterms
    ...
    run: /project/rapthor/Software/rapthor.rap-423/lib/python3.6/site-packages/rapthor/pipeline/steps/make_aterm_images.cwl
    in:
      - id: h5parm
