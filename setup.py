...
setup(
    ...
    install_requires=['numpy', 'scipy', 'astropy', 'jinja2', 'shapely', 'toil[cwl]<5.0',
    ...
    scripts=['bin/rapthor',
             ...
             'rapthor/scripts/make_aterm_config.py',
             ...
             'rapthor/scripts/run_wsclean_mpi.sh',
             'rapthor/scripts/run_wsclean_multiscale_mpi.sh',
