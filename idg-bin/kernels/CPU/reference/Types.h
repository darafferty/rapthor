...
/*
	Datatypes
*/
typedef UVW* UVWType[NR_TIMESTEPS];
typedef FLOAT_COMPLEX* VisibilitiesType[NR_TIMESTEPS][NR_CHANNELS][NR_POLARIZATIONS];
...
typedef FLOAT_COMPLEX* SubGridType[NR_POLARIZATIONS][SUBGRIDSIZE][SUBGRIDSIZE];
