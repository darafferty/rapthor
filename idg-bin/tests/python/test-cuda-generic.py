...
def main():
    ...
    grid          = idg.utils.get_example_grid(nr_polarizations,
                                               grid_size)
    grid2         = idg.utils.get_example_grid(nr_polarizations,
                                               grid_size)
    ...
    visibilities2 = idg.utils.get_example_visibilities(nr_baselines,
                                                       nr_time,
                                                       nr_channels,
                                                       nr_polarizations,
                                                       image_size,
    ...
    ######################################################################
    gridding(
        ref, visibilities, uvw, wavenumbers, baselines, grid,
        kernel_size, aterms, aterms_offset, spheroidal)

    gridding(
        ref, visibilities2, uvw, wavenumbers, baselines, grid2,
        kernel_size, aterms, aterms_offset, spheroidal)
    ...
    degridding(
        opt, visibilities2, uvw, wavenumbers, baselines, grid2,
        kernel_size, aterms, aterms_offset, spheroidal)
    ...
    ######################################################################
    idg.utils.plot_visibilities(visibilities2 - visibilities)
    plt.show()
