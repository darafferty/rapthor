...
#define LAYOUT_DIR          "examples/common/utility"
...
void init_metadata(void *ptr, void *uvw, void *wavenumbers, int nr_stations, int nr_baselines, int nr_timesteps, int nr_timeslots, int nr_channels, int gridsize, int subgridsize, float imagesize);
