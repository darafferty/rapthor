...
grid = numpy.zeros(shape=(nr_polarizations, grid_size, grid_size), dtype=numpy.complex64)
aterms = idg.utils.get_identity_aterms(nr_timeslots, nr_stations, subgrid_size, nr_polarizations)
...
visibilities = numpy.ones(shape=(nr_baselines, nr_time, nr_channels, nr_polarizations), dtype=idg.visibilitiestype)
...
image = numpy.zeros(shape=(nr_polarizations, grid_size, grid_size), dtype=numpy.complex64)
