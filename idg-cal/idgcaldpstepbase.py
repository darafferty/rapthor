...
class IDGCalDPStepBase(dp3.Step):
    ...
    def read_parset(self, parset, prefix):
        ...
        self.ampl_order = parset.get_int(prefix + "polynomialdegamplitude", 2)
        self.phase_order = parset.get_int(prefix + "polynomialdegphase", 1)
    ...
    def initialize(self):
        ...
        self.ampl_poly = LagrangePolynomial(order=self.ampl_order)
        self.phase_poly = LagrangePolynomial(order=self.phase_order)
