...
def run_image_sector(
    ...
    if sector["use_facets"]:
        ...
        region_record = require_file(str(sector["facet_region_path"]), "Facet region file")
    ...
    if nonpb_image is None or pb_image is None:
        ...
        nonpb_image = first_existing_file(nonpb_image_patterns, "WSClean non-PB image")
        pb_image = first_existing_file(pb_image_patterns, "WSClean PB image")
