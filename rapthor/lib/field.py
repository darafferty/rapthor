...
class Field(object):
    ...
    def __init__(self, parset, mininmal=False):
        ...
        self.slow_smoothnessconstraint1 = self.parset['calibration_specific']['slow_smoothnessconstraint1']
        self.slow_smoothnessconstraint2 = self.parset['calibration_specific']['slow_smoothnessconstraint2']
