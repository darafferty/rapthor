...
class ToilRunner(CWLRunner):
    ...
    def teardown(self) -> None:
        ...
        generated by the other. There is no easy way to determine exactly which
        subdirectories were created by this specific run. The "proper" solution
        is to wait for the Toil developers to come up with a proper fix.
        """
