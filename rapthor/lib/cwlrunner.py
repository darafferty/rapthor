...
class BaseCWLRunner:
    ...
    def parse_outputs(self) -> dict:
        """
        Parse the JSON file generated by the CWL runner that contains
...
class ToilRunner(CWLRunner):
    ...
    def teardown(self) -> None:
        ...
        files, at least when the option `--bypass-file-store` is used (see
        https://github.com/DataBiosphere/toil/issues/5226). Do the clean up
        ourselves, unless the user requested to keep those files.
