...
def main(
    ...
    img.write_catalog(
        outfile=output_catalog, format="fits", catalog_type="srl", incl_chan=True, clobber=True
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "cube_frequencies", help="Filename of input text file with cube frequency parameters"
    )
    ...
    parser.add_argument(
        "--rmsbox", help='Rms box width and step (e.g., "(60, 20)")', type=str, default="(150, 50)"
    )
    parser.add_argument(
        "--rmsbox_bright",
