...
def main(skymodel, h5parm_file, solset_name="sol000"):
    ...
    with h5parm(h5parm_file, readonly=False) as parms:
        ...
        if not hasattr(soltab, "dir"):
            print(
                f"The solutions in solution set {solset_name} of the input H5pram file are "
            ...
            sys.exit(
                "ERROR: The patches in the sky model and the directions in the h5parm "
        ...
        if direction_independent:
            ...
            for skymodel_source_name, skymodel_source_position in source_dict.items():
                ...
                ra, dec = normalize_ra_dec(
                    skymodel_source_position[0].value, skymodel_source_position[1].value
                )
            ...
            for source in soltab.dir:
                ...
                try:
                    ...
                    sys.exit(
                        "ERROR: A direction is present in the h5parm that is not in the sky model"
                    )
        ...
        _ = parms.H.create_table(
            snode, "source", descriptor, title="Source names and directions", expectedrows=25
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "h5parm_file", help="Filename of h5parm with cooresponding solutions to update"
    )
