...
def main(h5parm1, h5parm2, outh5parm, mode, solset1='sol000', solset2='sol000',
    ...
    # open them. The context is kept open until h1 and h2 are closed, after which they
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Close the files, copies are removed automatically by ending the tempdir context afterwards
        h1.close()
        h2.close()
        ho.close()
    ...
    if reweight:
        ...
        # In previous version of this script, the "ho" h5 table was closed at this point
        # and reopened later. This caused errors with "Resource temporarily unavailable"
        # to appear randomly, hence the ho table (and soltabs) is kept open.
